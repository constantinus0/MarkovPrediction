...
# object files
_OBJ = readFile.o diff.o minmax.o baseVector.o stateId.o stateMatrix.o smooth1d.o transitionMatrix.o probabilityMatrix.o binVal.o prediction.o smooth2d.o
